...
export default async function AdminHomePage() {
  ...
  const [artists, items, orders] = await Promise.all([listAdminArtists(), listAdminItems(), listAdminOrders()]);
  const cards = [
